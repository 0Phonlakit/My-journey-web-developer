...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res.sendStatus(404).json({ error: `Joke with id: ${id} not found. No jokes were deleted.` });
  };
...
app.delete("/all", (req, res) => {
  ...
  if (userKey === masterKey) {
    ...
    res.sendStatus(404).json({ error: `You are not authorised to perform this action.` });
  }
});
